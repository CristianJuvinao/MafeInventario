  ...
  return (
    <div className="page">
      ...
      <div style={{ marginBottom: 24, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: '-0.5px' }}>Proveedores</h1>
      ...
      {filtered.length === 0 ? (
        <div className="card" style={{ padding: 0 }}>
          <EmptyState
            ...
            sub={search ? 'Intenta con otro término de búsqueda' : 'Agrega tu primer proveedor para comenzar'}
          />
        </div>
      ) : (
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <div>
                    ...
                    {s.city && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: 'var(--text3)', fontSize: 12, marginTop: 2 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: s.active ? 'var(--green-dim)' : 'var(--surface2)',
