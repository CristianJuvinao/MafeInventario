        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
            ...
            <div className="card" style={{ padding: '20px 22px' }}>
              <div style={{ fontWeight: 800, fontSize: 15, marginBottom: 4 }}>Ganancias diarias</div>
              <div style={{ fontSize: 12, color: 'var(--text3)', marginBottom: 16 }}>Últimos 15 días</div>
              {stats.totalSales === 0 ? (
                <div style={{ textAlign: 'center', padding: '32px 0', color: 'var(--text3)', fontSize: 13 }}>
                  Sin datos aún
                </div>
                ...
                <>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 8, fontSize: 11, color: 'var(--text3)' }}>
                    ...
                    <span>{stats.dailyChart[stats.dailyChart.length - 1]?.label} (hoy)</span>
                  </div>
                </>
              )}
            </div>
          ...
          {/* By category */}
          <div className="card" style={{ padding: '20px 22px' }}>
            <div style={{ fontWeight: 800, fontSize: 15, marginBottom: 16 }}>Ventas por categoría</div>
